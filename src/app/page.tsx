...
/*
  Two-Week Study Timetable + Exam Season View (strict TS, no ESLint errors)
  -------------------------------------------------------------------------
  - Fortnight view: Week 1 / Week 2
  - Exam Season: Thu Oct 16 → Wed Nov 12 (ALL days included)
  - Checkboxes on every item; persisted with localStorage
  - Methods & Chemistry on Tue/Fri where applicable
  - VCAA priority; eve days = VCAA-only
*/

/* ------------------------------- types ------------------------------- */
type SubjectMeta = { label: string; color: string };
type SubjectKey =
  | "Methods"
  | "Physics"
  | "General Maths"
...
type FortnightSlot = { time: string; subject: string; text: string };
type FortnightDay = { day: string; studyGroup?: boolean; slots: FortnightSlot[] };

type PaperSlot = { subject: string; paper: string; optional?: string };
type ExamDay = {
  date: string; // "Thu Oct 16"
  slots?: PaperSlot[];
  note?: string; // "English eve — buffer"
  exam?: string; // "ENGLISH", "GM1", etc.
};
...
function SubjectTag({ name }: { name: SubjectKey | string }) {
  const fallback: SubjectMeta = {
    label: String(name),
    color: "bg-zinc-100 text-zinc-800 border-zinc-300",
  };
  const meta =
    (SUBJECTS as Record<string, SubjectMeta>)[String(name)] ?? fallback;
  return (
    <span
      className={cx(
...
const WEEK1: FortnightDay[] = [
  {
    ...
    slots: [
      { time: "11:00–12:30", subject: "Methods", text: "Practice Exam (Part A)" },
      {
        time: "13:00–14:30",
        subject: "Methods",
        text: "Review & error log (re-work top 3)",
      },
      {
        time: "15:00–16:30",
        subject: "English",
        text: "Exam Block 1: Analytical Essay (~60m) + quick skim",
      },
      {
        time: "17:00–18:30",
        subject: "English",
        text: "Exam Block 2: Argument Analysis (~60m) + notes for Creative",
      },
    ],
  },
  {
    ...
    slots: [
      {
        time: "10:30–16:00",
        subject: "Study",
        text: "Methods & Chemistry: 10:30–12:00 Methods • 12:00–12:30 Lunch • 12:30–14:00 Chem • 14:15–16:00 Mixed Qs",
      },
      {
        time: "17:30–19:00",
        subject: "English",
        text: "Plans bank (3 prompts, ~30m each)",
      },
    ],
  },
  {
    ...
    slots: [
      { time: "11:00–12:30", subject: "Physics", text: "Practice Exam (Part A)" },
      {
        time: "13:00–14:30",
        subject: "Physics",
        text: "Review & formula sheet updates",
      },
      {
        time: "15:00–16:30",
        subject: "General Maths",
        text: "Practice Exam (Part A)",
      },
      {
        time: "17:00–18:30",
        subject: "Methods",
        text: "Concept top-ups (derivatives/integration)",
      },
    ],
  },
  {
    ...
    slots: [
      {
        time: "10:30–16:00",
        subject: "Study",
        text: "Physics group: 10:30–12:00 timed • 12:00–12:30 Lunch • 12:30–14:00 pracs/data • 14:15–16:00 concept Qs",
      },
    ...
    slots: [
      {
        time: "10:30–16:00",
        subject: "Study",
        text: "Methods & Chem: 10:30–12:00 Methods • 12:00–12:30 Lunch • 12:30–14:00 Chem • 14:15–16:00 Mixed sets",
      },
      {
        time: "17:30–19:00",
        subject: "English",
        text: "Quick-write (intro + 2 body paras → polish)",
      },
    ],
  },
  {
    ...
    slots: [
      { time: "11:00–12:30", subject: "Chemistry", text: "Practice Exam (Part A)" },
      {
        time: "13:00–14:30",
        subject: "Chemistry",
        text: "Review & one-pager (topic summary)",
      },
      {
        time: "15:00–16:30",
        subject: "English",
        text: "Creative ~60m write + 0–30m self-mark",
      },
      {
        time: "17:00–18:30",
        subject: "General Maths",
        text: "Targeted drills (from error log)",
      },
    ],
  },
];

const WEEK2: FortnightDay[] = [
  {
    day: "Mon",
    slots: [
      ...
      { time: "15:00–16:30", subject: "Chemistry", text: "Topic sprint (2 weakest areas)" },
      {
        time: "17:00–18:30",
        subject: "English",
        text: "Quotes/themes bank + one refined paragraph",
      },
    ],
  },
  {
    ...
    slots: [
      {
        time: "10:30–16:00",
        subject: "Study",
        text: "Methods & Chemistry: long-form problems • rotations • peer marking",
      },
      {
        time: "17:30–19:00",
        subject: "Physics",
        text: "Derivation drills (6–8 marks worth)",
      },
    ],
  },
  {
    ...
    slots: [
      { time: "11:00–12:30", subject: "Chemistry", text: "Practice Exam (Part A)" },
      {
        time: "13:00–14:30",
        subject: "Chemistry",
        text: "Review & one-pager (e.g., redox/Ka/Ksp)",
      },
    ...
    slots: [
      {
        time: "10:30–16:00",
        subject: "Study",
        text: "Physics group: mock test + full debrief & error classes",
      },
    ...
    slots: [
      {
        time: "10:30–16:00",
        subject: "Study",
        text: "Methods & Chem: final mixed sets & paper swaps",
      },
...
function FortnightDayCard({
  ...
  return (
    <Card
      className={cx(
        "rounded-2xl shadow-sm border print:shadow-none",
        studyGroup ? "border-zinc-800" : "border-zinc-200"
      )}
    >
          ...
          <div className="flex items-center gap-2">
            <div
              className={cx(
                ...
                studyGroup ? "bg-zinc-900 text-white" : "bg-zinc-100 text-zinc-800"
              )}
            >
  ...
  return (
    <Card className={cx("rounded-2xl shadow-sm border", isExam ? "border-rose-400" : "border-zinc-200")}>
      <CardContent className="p-4 sm:p-5">
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-2">
            <div className="h-9 px-3 rounded-xl flex items-center justify-center bg-zinc-100 text-zinc-800">
          ...
          <div className="grid grid-cols-1 gap-3">
            {day.slots.map((s, i) => {
              ...
              return (
                <label
                  key={i}
                  className="grid grid-cols-[1fr_auto] items-center gap-3 rounded-xl border border-zinc-100 p-3 hover:border-zinc-200 transition-colors cursor-pointer"
                >
                  <div className="space-y-1">
                    <div className="flex items-center gap-2 flex-wrap">
                      <SubjectTag name={s.subject} />
                    ...
                    {s.optional && (
                      <div className="text-xs text-zinc-600">
                        + add if doing 2:{" "}
                        <span className="font-medium">{s.optional}</span>
                      </div>
                    )}
                  </div>
                  <input
...
export default function StudyTimetable() {
  type View = "W1" | "W2" | "EX";
  const [view, setView] = useState<View>("W1");
  const checks = useLocalChecks();

  const dataFortnight: FortnightDay[] = useMemo(
    () => (view === "W1" ? WEEK1 : WEEK2),
    [view]
  );
    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-zinc-50 print:bg-white">
      ...
      <header className="sticky top-0 z-30 backdrop-blur supports-[backdrop-filter]:bg-white/70 bg-white/80 border-b border-zinc-200 print:hidden">
        <div className="max-w-5xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <Button
              variant={view === "W1" ? "default" : "outline"}
              size="sm"
              onClick={() => setView("W1")}
            ...
            <Button
              variant={view === "W2" ? "default" : "outline"}
              size="sm"
              onClick={() => setView("W2")}
            ...
            <Button
              variant={view === "EX" ? "default" : "outline"}
              size="sm"
              onClick={() => setView("EX")}
              aria-label="Show Exam Season"
            >
              Exam Season
            </Button>
      ...
      <main className="max-w-5xl mx-auto px-4 py-6 print:py-4">
        ...
        <div className="mb-4 text-sm text-zinc-600">
          Non–study-group days start at 11:00 • Max 1.5 h blocks (study groups
          excluded) • Eve = VCAA only • Checkboxes save locally.
        </div>
        ...
        <div className="mt-6 text-xs text-zinc-500 print:text-[10px]">
          Tip: Use the Print / PDF button for a clean A4 export. Your checkboxes
